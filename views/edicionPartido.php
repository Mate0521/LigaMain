...
$partido->consultar(); // obtiene los goles actuales
...
//ya aqui hace el seteo y actualiza
    ...
    echo "<script>
            ...
            window.location.href = 'index.php?pid=PanelCam&id_cam=" . 
                $partido->getIdFecha()->getIdCampeonato()->getIdCampeonato() . "';
          </script>";
    exit();
}
?>
...
<div class="container text-center mt-4">
    <h3>Jugar Partido</h3>
    <form method="POST" class="d-inline-block bg-light text-dark p-4 rounded shadow" action="index.php?pid=EdicionPartido&idPartido=<?php echo $partido->getIdPartido()?>" name="actualizar">
        <div class="mb-3">
