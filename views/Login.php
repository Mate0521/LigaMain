      ...
      <div class="card border-0 bg-transparent">
        ...
        <div class="card-body p-5">
          ...
          <form method="post" action="index.php" name="autenticar">
            ...
            <button type="submit" class="btn btn-primary w-100 py-2" name="autenticar">Autenticar</button>

            <div class="mt-4 text-center">
              <p>¿No tienes cuenta?
                <button type="submit" class="btn btn-link p-0" name="newCliente">Regístrate aquí</button>
              </p>
            </div>
          </form>
        </div>
